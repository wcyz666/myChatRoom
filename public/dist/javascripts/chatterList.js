...
var ChatterList = React.createClass({displayName: "ChatterList",
    getInitialState: function(){
    ...
    render: function() {
        return (
            React.createElement("ul", {className: "list-unstyled"}, 
                React.createElement("li", {className: "li-name"}, 
                    React.createElement("span", {className: "label label-primary player-name"}, 
                        React.createElement("span", {className: "glyphicon glyphicon-user", "aria-hidden": "true"}), " ", userName
                    )
                ), 
                React.createElement(OtherChatterList, {chatters: this.state.chatters})
            )
        );
    }
});

var OtherChatterItem = React.createClass({displayName: "OtherChatterItem",
    render: function () {
        return (
            React.createElement("li", {className: "li-name"}, 
                React.createElement("span", {className: "label label-default player-name"}, this.props.children)
            )
        );
    }
});
var OtherChatterList = React.createClass({displayName: "OtherChatterList",
    propTypes: {
    ...
    render: function () {
        var chatters = this.props.chatters.map(function(element) {
            return (
                React.createElement(OtherChatterItem, {key: element}, element)
            );
        });
        return (
...
React.render(
    React.createElement(ChatterList, null),
